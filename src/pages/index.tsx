...
export default function Home() {
  return (
    <div
      className={`${geistSans.variable} ${geistMono.variable} min-h-screen flex flex-col items-center justify-center font-[family-name:var(--font-geist-sans)] bg-gradient-to-br from-blue-100 via-white to-gray-100 relative overflow-hidden`}
    >
      ...
      <p className="text-lg text-gray-700 mt-4 text-center z-10 max-w-3xl">
        Empowering businesses with cutting-edge digital solutions. From mobile apps to 
        web platforms, we bring your ideas to life with innovation, precision, and passion.
      </p>
